...
namespace CaseStudy
{
    class AppEngine
    {
        ...
        {
            con = new SqlConnection("data source = RMGW58ZLPC0848\\SQLEXPRESS; Initial Catalog=SMS; user id=sa; password=Temp1234");
            con.Open();
            return con;
        }
        ...
        public void studentregister(Student student)
        {
            ...
            try
            {
                ...
                if (res > 0)
                    Console.WriteLine(" The row is  inserted");
                else
                    Console.WriteLine(" The row is Not Inserted");
        ...
        internal void register(object std1)
        {
            throw new NotImplementedException();
        }

        internal void Register(object std2)
        {
            throw new NotImplementedException();
        }
        ...
        //    {
        //        new Student(1,"Sreedhar", "27/03/1998"),
        //       new Student(2,"Pavan", "06/06/2000"),
        //       new Student(3,"Kiran", "25/05/1999")
        //    };
        ...
        //   {
        //         new Course(151,"java",60,34500.00f),
        //        new Course(152,"Sql",46,12000.00f),
        //        new Course(153,"DotNet",37,28000.00f)
        //   };
        //    return courses;
        //}
        ...
        //      new Enroll(new Student(1,"sreeedhar", "27/03/1998" ), new Course(151, "Java", 60, 35000.00f), Convert.ToDateTime(DateTime.Now)),
        //      new Enroll(new Student(2, "pavan", "21/05/2000"), new Course(152, "Sql", 46, 25000.00f), Convert.ToDateTime(DateTime.Now)),
        //      new Enroll(new Student(3,  "kiran", "25/05/1999"), new Course(153, "DotNet", 37, 40000.00f), Convert.ToDateTime(DateTime.Now))
        //    };
        //    return enroll;
        //}
        ...
        //      new Enroll(new Student(1, "Sreedhar", "27/03/1998"), new Course(151, "Java", 60, 34500.00f), Convert.ToDateTime(DateTime.Now)),
        //      new Enroll(new Student(2, "Pavan", "06/06/2000"), new Course(152, "Sql", 46, 12000.00f), Convert.ToDateTime(DateTime.Now)),
        //      new Enroll(new Student(3, "Kiran", "25/05/1999"), new Course(153, "DotNet", 37, 28000.00f), Convert.ToDateTime(DateTime.Now))
        //    };
        //    return enroll;
        //}
        ...
        public void UpdateStudent()
        {
            try
            {
                Console.WriteLine("enter the Student id is :");
                int id = Convert.ToInt32(Console.ReadLine());
                Console.WriteLine("enter the Student Name is :");
                string name = Console.ReadLine();
                Console.WriteLine("enter the Student DOB  is :");
                ...
                if (res > 0)
                {
                    Console.WriteLine("The row is Updated");
                }
                else
                {
                    Console.WriteLine("The row is Not Updated");
                }
            }
            catch (SqlException ex)
            {
        ...
        public void DeleteStudents()
        {
            try
            {
                ...
                int res = cmd.ExecuteNonQuery();
                if (res > 0)
                    Console.WriteLine(" The row is Delete Successfully");
                else
                    Console.WriteLine(" The row is  Not Deleted");
            }
            catch (SqlException ex)
            {
                Console.WriteLine(ex);
        ...
        public void EnrollstudentDetailslists()
        {
            try
            {
                ...
                if (res > 0)
                {
                    Console.WriteLine(" The row  is inserted Successfully");
                }
                else
                {
                    Console.WriteLine(" The row  is not inserted ");
