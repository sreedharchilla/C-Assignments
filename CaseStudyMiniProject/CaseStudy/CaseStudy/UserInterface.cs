...
namespace CaseStudy
{
    class UserInterFace : interfaceuseraction
    {
            ...
            do
            {
                ...
                switch (op)
                {
                    case 1:
                        ...
                        Console.WriteLine(" The action is Completed you may Exit");
                        break;
                    case 2:
                    ...
                    default:
                        ...
                        Console.WriteLine(" The enter valid option are ");
                        break;
                }
            ...
            do
            {
                ...
                switch (op)
                {
                    case 1:
                        ...
                        Console.WriteLine(" The action Completed you may Exit");
                        break;
                    case 2:

                        Console.WriteLine("&&&&&&&&&&&&&&&&   All  Courses are avaialable in Institute     &&&&&&&&&&&&&&&&");
                    ...
                    default:
                        Console.WriteLine(" Please enter the valid Option here");
                        break;
                }
        ...
        {
            Console.WriteLine("List of All Student Details are : ");
        ...
        {
            Console.WriteLine("List of all courses are : ");
            engine.AllCoursesLists();
        }
    }
}
